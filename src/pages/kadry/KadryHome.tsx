...
const pricingSegments = [
  ...
  { segment: 'Младший юрист', salary: '~ 90 000 ₽', price: '≈ 4 900 ₽' },
]
...
const schools = [
  ...
  'СГЮА', 'СПбГАУ', 'СПбГЭУ', 'ОмГУ им. Ф.М. Достоевского', 'ЮУрГУ (НИУ)', 'СЗФ РГУП',
]
...
export default function KadryHome() {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    submitLead({
      ...
      interest: form.position.trim() ? [`Ищем: ${form.position.trim()}`] : [],
    })
    setSent(true)
  }
