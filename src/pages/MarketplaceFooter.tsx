...
// Единый подвал раздела «Маркетплейс» — та же структура, что и у подвалов
// остальных разделов (EventsFooter/CommunityFooter/KadryFooter): яркие
// заголовки колонок, приглушенные ссылки, соцсети отдельной полноширинной
// строкой.
